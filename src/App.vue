    ...
    <div class="bg-white rounded-3xl shadow-2xl w-full max-w-sm overflow-hidden ring-1 ring-gray-200">
      ...
      <div class="p-6 space-y-4">
        <div>
          ...
          <input type="text" v-model="formProfile.username" class="w-full bg-white border border-gray-200 rounded-xl px-4 py-2.5 focus:ring-2 focus:ring-yellow-500 outline-none font-medium text-gray-700">
        </div>
        <div>
          ...
          <input type="password" v-model="formProfile.password" class="w-full bg-white border border-gray-200 rounded-xl px-4 py-2.5 focus:ring-2 focus:ring-yellow-500 outline-none font-medium text-gray-700" placeholder="Minimal 6 karakter">
        </div>
      </div>
      <div class="bg-gray-50 px-6 py-4 flex justify-end gap-3 border-t border-gray-100">
        ...
        <button @click="saveProfile" class="bg-yellow-500 hover:bg-yellow-600 text-white px-6 py-2 rounded-xl font-bold shadow-md transition-colors active:scale-95">Simpan Profil</button>
      </div>
    </div>
  </div>
</template>
