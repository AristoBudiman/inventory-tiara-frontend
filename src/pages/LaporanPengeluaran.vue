  ...
  <div class="p-8 max-w-6xl mx-auto space-y-6 animate-fade-in">
    ...
    <div class="bg-white p-5 rounded-xl shadow-sm border border-red-100 flex flex-col md:flex-row items-end gap-5 mb-4">
      <div class="flex-1 w-full">
        ...
        <input type="date" v-model="startDate" @change="fetchBelanja" class="w-full border-2 border-gray-300 rounded-lg p-2.5 font-bold outline-none focus:border-red-500 text-gray-700 bg-gray-50 focus:bg-white transition-colors cursor-pointer">
      </div>
      <div class="flex-1 w-full">
        <label class="block text-[10px] font-black text-red-800 uppercase tracking-wider mb-2">Periode Sampai</label>
        <input type="date" v-model="endDate" @change="fetchBelanja" class="w-full border-2 border-gray-300 rounded-lg p-2.5 font-bold outline-none focus:border-red-500 text-gray-700 bg-gray-50 focus:bg-white transition-colors cursor-pointer">
      </div>
